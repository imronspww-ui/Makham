...
import {
  ...
  Settings, LogOut, ExternalLink, Store, Users, ShoppingBag, TrendingDown, QrCode, BarChart2,
} from 'lucide-react'
...
const adminNavItems = [
  ...
  { href: '/admin/analytics', label: 'วิเคราะห์',       icon: BarChart2       },
  { href: '/admin/tables',    label: 'QR โต๊ะ',         icon: QrCode          },
